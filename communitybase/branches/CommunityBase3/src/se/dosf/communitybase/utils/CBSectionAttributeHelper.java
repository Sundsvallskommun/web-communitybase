...
public class CBSectionAttributeHelper {
	...
	public static void setCreated(SimpleSectionDescriptor descriptor, Timestamp created) {

		if (created == null) {

			descriptor.getAttributeHandler().removeAttribute(CBConstants.SECTION_ATTRIBUTE_CREATED);

		} else {

			descriptor.getAttributeHandler().setAttribute(CBConstants.SECTION_ATTRIBUTE_CREATED, DateUtils.DATE_TIME_SECONDS_FORMATTER.format(created));
		}
	}

	public static Timestamp getCreated(SectionDescriptor descriptor) {

		Date date = DateUtils.getDate(DateUtils.DATE_TIME_SECONDS_FORMATTER, descriptor.getAttributeHandler().getString(CBConstants.SECTION_ATTRIBUTE_CREATED));
	...
	public static void setDeleteOnDate(SimpleSectionDescriptor descriptor, Date sectionDeleteDate) {

		if (sectionDeleteDate == null) {

			descriptor.getAttributeHandler().removeAttribute(CBConstants.SECTION_ATTRIBUTE_DELETEONDATE);

		} else {

			descriptor.getAttributeHandler().setAttribute(CBConstants.SECTION_ATTRIBUTE_DELETEONDATE, DateUtils.DATE_FORMATTER.format(sectionDeleteDate));
		}
	}

	public static Timestamp getDeleteOnDate(SectionDescriptor descriptor) {

		Date date = DateUtils.getDate(DateUtils.DATE_FORMATTER, descriptor.getAttributeHandler().getString(CBConstants.SECTION_ATTRIBUTE_DELETEONDATE));
	...
	public static void setLastActivityDate(SectionDescriptor descriptor, Date date) {
		
		if (date == null) {

			descriptor.getAttributeHandler().removeAttribute(CBConstants.SECTION_ATTRIBUTE_LASTACTIVEDATE);

		} else {

			descriptor.getAttributeHandler().setAttribute(CBConstants.SECTION_ATTRIBUTE_LASTACTIVEDATE, date);
		}
	}
}
