...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="Register">
		...
		<section>
			...
			<form action="{/Document/requestinfo/uri}" id="registrationForm" method="post" enctype="multipart/form-data">
				<article>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="firstname"><xsl:value-of select="$i18n.Firstname"/></label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="lastname"><xsl:value-of select="$i18n.Lastname"/></label>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="email"><xsl:value-of select="$i18n.Email"/></label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="phone"><xsl:value-of select="$i18n.Phone"/></label>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="organization"><xsl:value-of select="$i18n.Organization"/></label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="title"><xsl:value-of select="$i18n.Title"/></label>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="password"><xsl:value-of select="$i18n.ChoosePassword"/></label>
								...
								<small class="form-text text-muted"><xsl:value-of select="$i18n.PasswordStrengthDescription" /></small>
							</div>
						</div>
		
						<div class="col-md-6">
							<div class="form-group">
								<label for="passwordMatch"><xsl:value-of select="$i18n.ConfirmPassword"/></label>
						...
						<div class="row mt-3">
							<div class="col-12">
								<div class="form-check">
									...
									<xsl:text> (</xsl:text>
									<a href="#" id="showApprovalText" data-toggle="modal" data-target="#registrationapprovalmodal"><xsl:value-of select="$i18n.ReadMore"/></a>
									<xsl:text>)</xsl:text>
		...
		<xsl:if test="RegistrationApprovalLabel">
			<div class="modal fade" id="registrationapprovalmodal">
		...
		<xsl:if test="messageKey">
			<xsl:choose>
				...
				<xsl:when test="messageKey='RegistrationTextNotApproved'">
					<div class="validationerror" data-parameter="dummyValidationField">
						<i class="icons icon-warning"/>
