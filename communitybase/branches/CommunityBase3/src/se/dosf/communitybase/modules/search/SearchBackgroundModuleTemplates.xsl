	...
	<xsl:template match="Document">
		...
		<div class="site-search-container" id="site-search" data-searchmoduleuri="{SearchModuleURI}" data-contextpath="{ContextPath}">
			<div class="search-wrapper">
				<input data-hrefbase="{SearchModuleURI}" type="search" placeholder="{$i18n.SearchPlaceholder}" name="search" class="form-control search-input" aria-autocomplete="list" data-controls="search-result-container-std search-result-container"/>
				...
				<div class="search-no-hits-template">
					<div class="col-lg-12">
						<div class="contentitem">
							<section>
								<article>
									<div class="italic"><xsl:value-of select="$i18n.NoHitsClickBelow"/></div>
								</article>
							</section>
						</div>
					</div>
