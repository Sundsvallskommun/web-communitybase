...
public class CommunityModuleDAO extends BaseDAO {
	...
	public void enableModule(ModuleDescriptor moduleDescriptor, CommunityGroup group) throws SQLException {
		...
		try {
			...
			checkQuery.setInt(2, moduleDescriptor.getModuleID());
			...
			if(!checkQuery.executeQuery()){
				...
				insertQuery.setInt(2, moduleDescriptor.getModuleID());
