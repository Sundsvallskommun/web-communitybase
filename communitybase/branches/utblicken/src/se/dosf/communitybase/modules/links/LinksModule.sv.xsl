...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="updateLinkBreadcrumb">Uppdatera länk</xsl:variable>
	...
	<xsl:variable name="links.update.title" select="'Redigera länk'" />
	...
	<xsl:variable name="updateLink.header" select="'Uppdatera länk'" />
