...
public class LinkDAO extends BaseDAO {
	...
	public Link getGroupLink(int groupID) throws SQLException{
		String sql = "SELECT links.* " +
		"FROM links, linkgroups, users " +
		"WHERE linkgroups.groupID = ? AND linkgroups.linkID = links.linkID and links.posterID = users.userID;";
	...
	public void deleteSchoolLink(Integer linkID) throws SQLException{
		UpdateQuery query = new UpdateQuery(this.dataSource.getConnection(),true,"DELETE FROM links WHERE linkID = ?");
	...
	public void deleteGlobalLink(Integer linkID) throws SQLException{
		UpdateQuery query = new UpdateQuery(this.dataSource.getConnection(),true,"DELETE FROM links WHERE linkID = ?");
	...
	public Link getLink(Integer linkID) throws SQLException {
