...
public class Post {
	...
	public Element toXML(Document doc) {
		...
		if (this.getChanged() != null) {
			...
			changed.appendChild(XMLUtils.createElement("changedDate", date.format(getChanged()), doc));
			changed.appendChild(XMLUtils.createElement("changedTime", time.format(getChanged()), doc));
