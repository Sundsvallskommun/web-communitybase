...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			...
			<div class="adminDiv">
				...
				<div class="noBorderDiv">
					<form method="post" action="{/document/requestinfo/contextpath}{/document/section/fullAlias}/{/document/module/alias}/addAdmin">
						<xsl:value-of select="$systemInfoElement.addadmins.email" />: <input type="text" name="email" size="70" value="{requestparameters/parameter[name='email']/value}"/>
	...
	<xsl:template match="group" mode="tree">
		...
		schooltree<xsl:value-of select="/document/module/moduleID"/>.add('group<xsl:value-of select="groupID"/>','school<xsl:value-of select="../../schoolID"/>','<xsl:value-of select="$name"/>','<xsl:value-of select="/document/requestinfo/contextpath"/>/<xsl:value-of select="/document/groupAdminModuleAlias"/>/<xsl:value-of select="groupID"/>','<xsl:value-of select="$name"/>','','<xsl:value-of select="/document/requestinfo/contextpath"/>/static/f/<xsl:value-of select="/document/module/sectionID"/>/<xsl:value-of select="/document/module/moduleID"/>/pics/group.png','','',
		...
		<div class="adminDiv">
			...
			<div class="noBorderDiv">
				<form method="post" action="{/document/requestinfo/contextpath}{/document/section/fullAlias}/{/document/module/alias}/{/document/school/schoolID}/addSchoolAdmin">
					<xsl:value-of select="$schoolInfoElement.addresource.email" />: <input type="text" name="email" size="70" value="{requestparameters/parameter[name='email']/value}"/>
