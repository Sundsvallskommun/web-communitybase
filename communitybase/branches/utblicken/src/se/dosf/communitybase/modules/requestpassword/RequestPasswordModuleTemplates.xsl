		...
		<div class="contentitem">
			...
			<form method="post" name="mysettings" id="mysettings" action="{/document/requestinfo/url}">
				<div class="divNormal">
					...
					<p class="floatleft" style="margin-bottom: 10px"><xsl:value-of select="$RequestNewPassword.information" />.</p>
					
					<div class="bigmarginbottom">
						<div style="width: 15%;" class="floatleft"><xsl:value-of select="$RequestNewPassword.email" />:</div>
						<div>
