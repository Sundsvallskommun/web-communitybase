...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="multiUploader.language" select="'language.sv.js'" />
	<xsl:variable name="multiUploader.uploadbutton" select="'upload.sv.png'" />
	...
	<xsl:variable name="addImages.information.part1" select="'För att ladda upp flera bilder samtidigt krävs Adobe Flash Player version'" />
	<xsl:variable name="addImages.information.part2" select="'eller senare'" />
	<xsl:variable name="addImages.information.part3" select="'för att ladda ner senaste versionen av Adobe Flash Player eller ladda upp en bild/zip-fil nedan'" />
	...
	<xsl:variable name="pictureGallery.downloadGroupGallery.part1" select="'Ladda ner albumet'" />
	<xsl:variable name="pictureGallery.downloadGroupGallery.part2" select="'som en zip-fil'" />
