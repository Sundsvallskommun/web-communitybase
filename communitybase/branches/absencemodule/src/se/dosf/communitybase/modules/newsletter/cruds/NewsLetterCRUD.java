...
public class NewsLetterCRUD extends IntegerBasedCommunityBaseCRUD<NewsLetter, NewsLetterModule> {
	...
	@Override
	protected List<Breadcrumb> getUpdateBreadcrumbs(NewsLetter bean, HttpServletRequest req, HttpServletResponse res, CommunityUser user, URIParser uriParser) throws Exception {
	...
	@Override
	protected List<Breadcrumb> getShowBreadcrumbs(NewsLetter bean, HttpServletRequest req, HttpServletResponse res, CommunityUser user, URIParser uriParser) {
	...
	@Override
	protected List<Breadcrumb> getListBreadcrumbs(HttpServletRequest req, HttpServletResponse res, CommunityUser user, URIParser uriParser, ValidationError validationError) {
	...
	@Override
	public NewsLetter getRequestedBean(HttpServletRequest req, HttpServletResponse res, CommunityUser user, URIParser uriParser) throws SQLException, AccessDeniedException {
		
		NewsLetter newsLetter = super.getRequestedBean(req, res, user, uriParser);
