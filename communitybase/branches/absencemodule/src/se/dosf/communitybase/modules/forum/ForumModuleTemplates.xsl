...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="updateCommunity">
		...
		<form method="POST" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			...
			<div class="content-box">									
				<h1 class="header">
					<xsl:value-of select="$updateCommunity.header" />:<xsl:text>&#160;</xsl:text><xsl:value-of select="community/name" />
				</h1>
	...
	<xsl:template match="addCommunityThread">
		...
		<form method="post" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			<div class="content-box">		
				...
				<h1 class="header"><xsl:value-of select="$addCommunityThread.header" /><xsl:text>&#160;</xsl:text><xsl:value-of select="community/name"/></h1>
	...
	<xsl:template match="updateCommunityPost">
		...
		<form method="POST" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			...
			<div class="content-box">
				...
				<h1 class="header"><xsl:value-of select="$updateCommunityPost.header" /></h1>
