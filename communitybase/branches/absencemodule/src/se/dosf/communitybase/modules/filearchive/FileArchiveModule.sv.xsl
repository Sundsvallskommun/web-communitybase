...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="updateGroupCategoryBreadcrumb">Ändra gruppkategori </xsl:variable>
	<xsl:variable name="updateSchoolCategoryBreadcrumb">Ändra skolkategori </xsl:variable>
	...
	<xsl:variable name="file.edit.title" select="'Ändra fil'" />
	...
	<xsl:variable name="updateGroupSection.header" select="'Ändra gruppkategorin'" />
	<xsl:variable name="updateSchoolSection.header" select="'Ändra skolkategorin'" />
	...
	<xsl:variable name="updateFile.header" select="'Ändra filen'" />
