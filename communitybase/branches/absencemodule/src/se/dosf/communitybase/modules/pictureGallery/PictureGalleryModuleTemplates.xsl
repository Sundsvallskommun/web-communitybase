...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="pictureGallery">
		...
		<div class="floatleft full">
			...
			<div class="content-box">
				...
				<h1 class="header"><xsl:value-of select="$pictureGallery.header" /><xsl:text>&#x20;</xsl:text><xsl:value-of select="../group/name"/></h1>
		...
		<div class="floatleft full">
			...
			<div class="content-box">
				...
				<h1 class="header"><xsl:value-of select="$pictureGallery.header" /><xsl:text>&#x20;</xsl:text><xsl:value-of select="../group/school/name"/></h1>
	...
	<xsl:template match="showGallery">
		...
		<div class="floatleft full">
			<div class="content-box">
		  			<h1 class="header"><xsl:value-of select="gallery/sectionName"/> (<xsl:value-of select="gallery/numPics"/><xsl:text>&#x20;</xsl:text><xsl:value-of select="$showGallery.pictures" />)</h1>
	...
	<xsl:template match="showImage">
        ...
        <div class="floatleft full">
			<div class="content-box">
		  		<h1 class="header"><xsl:value-of select="gallery/sectionName"/> (<xsl:value-of select="gallery/numPics"/><xsl:text>&#x20;</xsl:text><xsl:value-of select="$showImage.pictures" />)</h1> 
