...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="updateGroupBreadCrumbTest">Byt namn på gruppen: </xsl:variable>
	...
	<xsl:variable name="schools.tree.loadingTitle" select="'Hämtar förskolor och grupper'" />
	<xsl:variable name="schools.tree.filter" select="'Filtrera'" />
	<xsl:variable name="schools.tree.restore" select="'Återställ filtrering'" />
