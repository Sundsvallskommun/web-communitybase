...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="addLinkBreadcrumb">Lägg till länk</xsl:variable>
	<xsl:variable name="updateLinkBreadcrumb">Ändra länk</xsl:variable>
	
	<!--  -->
	<xsl:variable name="i18n.link.newNotification">Ny länk sedan du besökte länkarkivet senast</xsl:variable>
	<xsl:variable name="i18n.link.publishTo">Gör länken åtkomlig för</xsl:variable>
	...
	<xsl:variable name="i18n.AllLinks">Alla länkar</xsl:variable>
	<xsl:variable name="i18n.NoLinks">Det finns för närvarande inga länkar här</xsl:variable>
	<xsl:variable name="i18n.DeleteLink">Ta bort länk</xsl:variable>
	<xsl:variable name="i18n.AddLink">Lägg till länk</xsl:variable>
	<xsl:variable name="i18n.EditLink">Ändra länk</xsl:variable>
