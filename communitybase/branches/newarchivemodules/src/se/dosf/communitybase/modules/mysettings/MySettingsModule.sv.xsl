...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="MySettingsModule.information1" select="'Välkommen till mina inställningar. Här kan du du ändra personuppgifter, e-postresumé, e-postadress och lösenord'" />
	<xsl:variable name="MySettingsModule.information2" select="'E-postresumé är ett e-postmeddelande som skickas varje dag med ett kort utdrag av vad som hänt sedan du senast var inloggad'" />
	...
	<xsl:variable name="user.emailresume.header" select="'E-postresumé'" />
