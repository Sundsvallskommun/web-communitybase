...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="RequestNewPassword.email" select="'E-postadress'" />
	...
	<xsl:variable name="validationError.messageKey.UserNotFound" select="'E-postadressen du angivit existerar inte i föräldramötet'" />
