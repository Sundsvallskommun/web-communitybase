...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="post.publish" select="'Publicera kalenderposten till'" />
	<xsl:variable name="post.noaccess" select="'Du har inte rättighet till någon förskola'" />
	...
	<xsl:variable name="post.sendReminder" select="'Skicka påminnelse dagen innan'" />
	<xsl:variable name="post.reminderIsSent" select="'Påminnelse kring händelsen skickas ut dagen innan'" />
