...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="newslettermodule.publishedTo" select="'Visas för'" />
	
	<xsl:variable name="newsletter.title" select="'Rubrik'" />
	<xsl:variable name="newsletter.publish" select="'Publicera nyhetsbrevet till'" />
	...
	<xsl:variable name="newsletter.noaccess" select="'Du har inte rättighet till någon förskola'" />
	
	<xsl:variable name="newsletter.draft.title">[ej publicerat]</xsl:variable>
	
	<xsl:variable name="newsletter.publishing">Publicering</xsl:variable>
	<xsl:variable name="newsletter.published1">Publicera nyhetsbrevet</xsl:variable>
	<xsl:variable name="newsletter.saveAsDraft">Spara nyhetsbrevet för senare publicering</xsl:variable>
	...
	<xsl:variable name="showReadReceipt.summary.part2" select="'användare har läst nyhetsbrevet, varav'" />
	<xsl:variable name="showReadReceipt.summary.part3" select="'är dolda'" />
	...
	<xsl:variable name="showReadReceipt.noreceiptAccess">Du har inte rätt att se några läskvitton för det här nyhetsbrevet.</xsl:variable>
