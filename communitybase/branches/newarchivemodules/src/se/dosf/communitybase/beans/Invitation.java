...
public class Invitation implements Elementable {
	...
	public Element toXML(Document doc) {
		...
		XMLUtils.appendNewElement(doc, invitationElement, "expires", DateUtils.DATE_TIME_FORMATTER.format(expires));
		...
		if(this.updated != null){
			XMLUtils.appendNewElement(doc, invitationElement, "updated", DateUtils.DATE_TIME_FORMATTER.format(this.updated));
		}

		if(this.lastSent != null){
			XMLUtils.appendNewElement(doc, invitationElement, "lastSent", DateUtils.DATE_TIME_FORMATTER.format(this.lastSent));
		}
