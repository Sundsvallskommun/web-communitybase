...
public class ModuleSettingsCascadeModule extends AnnotatedForegroundModule {
	...
	@EventListener(channel=ForegroundModuleDescriptor.class)
	public void foregroundModuleUpdated(CRUDEvent<ForegroundModuleDescriptor> event, EventSource source){
		
		if(source == EventSource.LOCAL){
			
			for(ForegroundModuleDescriptor moduleDescriptor : event.getBeans()){
	...
	@EventListener(channel=BackgroundModuleDescriptor.class)
	public void backgroundModuleUpdated(CRUDEvent<BackgroundModuleDescriptor> event, EventSource source){
		
		if(source == EventSource.LOCAL){
			
			for(BackgroundModuleDescriptor moduleDescriptor : event.getBeans()){
