...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="user.update.language" select="'Language'" />
	...
	<xsl:variable name="groupInfoElement.adduser.language" select="'Language'" />
	...
	<xsl:variable name="validationError.messageKey.NoUserChoosen" select="'You need to choose at least one user to move'" />
