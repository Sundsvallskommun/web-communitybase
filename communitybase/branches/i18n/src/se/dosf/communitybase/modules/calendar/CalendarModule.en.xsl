...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="newCalendarPostTest">New calendar entry: </xsl:variable>

	<xsl:variable name="updatePostBreadCrumb">Change calendar entry</xsl:variable>
	...
	<xsl:variable name="post.showcalendarpost" select="'Show calendar entry to'" />
	<xsl:variable name="post.showcalendarpost.group" select="'Group'" />
	<xsl:variable name="post.showcalendarpost.school" select="'The whole preschool'" />
	<xsl:variable name="post.showcalendarpost.all" select="'All preschools'" />
	...
	<xsl:variable name="showPost.changepost.title" select="'Change the calendar entry'" />
	<xsl:variable name="showPost.delete.confirm" select="'Are you sure you want to delete the calendar entry'" />
	<xsl:variable name="showPost.delete.title" select="'Delete the calendar entry'" />
	...
	<xsl:variable name="showReadReceipt.summary.part2" select="'users have read the calendar entry'" />
