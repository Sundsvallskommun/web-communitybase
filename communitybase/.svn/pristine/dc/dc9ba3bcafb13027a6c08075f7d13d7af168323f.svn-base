...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<div class="tableCalendar">
			...
			<div class="floatleft" >
				<div class="floatleft bigmarginbottom">
					<p style="font-style: italic; padding: 1px 1px 1px 3px; width: 64.5em; background-color: #F0F2F4;">
	...
	<xsl:template match="addSchoolSection">
		...
		<form method="post" action="{/document/requestinfo/currentURI}/{/document/module/alias}/{/document/group/groupID}/addSchoolSection" ACCEPT-CHARSET="ISO-8859-1">
			<table class="normal">									
				<tr>
					<th colspan="2" align="left"><xsl:value-of select="$addSection.header" /></th>
				</tr>
				<tr>
					<td colspan="2"><xsl:apply-templates select="validationException/validationError" /></td>
				</tr>
				<tr>
					<td><xsl:value-of select="$addSection.name" />:</td>
					<td><input type='text' name='sectionname' size='65' maxlength='65'/></td>
				</tr>				
				<tr>
					<td colspan="2" align="right"><input type="submit" value="{$addSchoolSection.submit}"/></td>
				</tr>
			</table>
		</form>		
	</xsl:template>
