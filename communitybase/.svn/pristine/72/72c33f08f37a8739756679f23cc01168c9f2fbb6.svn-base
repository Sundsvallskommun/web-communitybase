...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="Document">
		...
		<div class="contentitem">
			...
			<xsl:apply-templates select="AbsenceUserSettings" />
	...
	<xsl:template match="ListAbsences">
		...
		<div class="content-box noprint">
			<h1 class="header"><xsl:value-of select="$i18n.SearchCriterias" /></h1>
		...
		<div class="clearboth floatright text-align-right margintop">
			<a href="{$modulePath}/usersettings" title="{$i18n.AbsenceUserSettings}"><img src="{$moduleImagePath}/spanner.png" class="vertical-align-middle" /><xsl:text>&#160;</xsl:text></a>
			<a href="{$modulePath}/usersettings" title="{$i18n.AbsenceUserSettings}">
				<xsl:value-of select="$i18n.AbsenceUserSettings" />
			</a>
		</div>
	...
	<xsl:template match="UpdateAbsence">
		...
		<form method="post" name="updateAbsence" id="updateAbsence" action="{/Document/requestinfo/uri}">
			...
			<div class="content-box">
				<h1 class="header">
					<xsl:value-of select="$i18n.UpdateAbsence" />
				</h1>
	...
	<xsl:template match="AbsenceUserSettings">
		
		<form method="post" name="userSettings" id="userSettings" action="{/Document/requestinfo/uri}">
				...
				<div class="content">
					...
					<div class="floatleft full">
						<xsl:call-template name="createCheckbox">
							<xsl:with-param name="id" select="'absencenotification'" />
							<xsl:with-param name="name" select="'absencenotification'" />
							<xsl:with-param name="elementName" select="'hasAbsenceNotification'" />
							<xsl:with-param name="element" select="." />
						</xsl:call-template>
						<label for="absencenotification"><xsl:value-of select="$i18n.AbsenceNotificationDescription" />:</label>
					</div>
