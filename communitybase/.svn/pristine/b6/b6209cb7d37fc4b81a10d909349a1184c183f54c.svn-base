			...
			<script type="text/javascript" language="javascript" src="{/document/requestinfo/contextpath}/static/f/{/document/module/sectionID}/{/document/module/moduleID}/js/datepicker/js/datepicker.js" />
           	...
           	<div class="content-box">
				...
				<div class="content">
					...
					<p>
						<label for="title"><xsl:value-of select="$post.name" />:</label><br />
						<input type="text" id="title" name="title" size="72" value="{requestparameters/parameter[name='title']/value}"/>
					</p>
					
					<p>
						<label for="description"><xsl:value-of select="$post.description" /></label><br />
            ...
            <div class="content-box">
				...
				<div class="content">
					...
					<div class="floatright">
						...
						<input class="marginleft" type="submit" value="{$updatePost.submit}" />
					</div>
			...
			<div class="content">
				...
				<table class="full border marginbottom">
					...
					<tr>
						...
						<th colspan="6" align="left"><xsl:value-of select="calendarPost/datetime/daytext" /> 
						<xsl:text>&#x20;</xsl:text>
