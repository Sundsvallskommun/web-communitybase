...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="groupLinks">
		...
		<div class="content-box">
			<h1 class="header"><span><xsl:value-of select="/document/group/name"/></span></h1>
	...
	<xsl:template name="schoolLinks">
		...
		<div class="content-box">
			<h1 class="header"><span><xsl:value-of select="$schoolLinks.header" /><xsl:text>&#x20;</xsl:text><xsl:value-of select="schoolName"/></span></h1>
	...
	<xsl:template name="globalLinks">
		...
		<div class="content-box">
			<h1 class="header"><span><xsl:value-of select="$globalLinks.header" /></span></h1>
	...
	<xsl:template match="link">
		...
		<div class="floatleft full bigmarginbottom hover">
	...
	<xsl:template match="updateLink">
		...
		<form method="POST" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$updateLink.header" /><xsl:text>&#160;</xsl:text>"<xsl:value-of select="substring(link/description,1, 30)"/>"</span>
				</h1>
	...
	<xsl:template name="addLinkForm">
		...
		<div class="content-box">
			<h1 class="header"><span><xsl:value-of select="$header" /></span></h1>
