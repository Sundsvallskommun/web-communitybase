...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="user.update.header" select="'Ändra användaren'" />
	...
	<xsl:variable name="users.copy.header" select="'Flytta användare'" />
	<xsl:variable name="users.copy.text.part1" select="'Du har valt att kopiera'" />
	<xsl:variable name="users.copy.text.part2" select="'st användare.'" />
	<xsl:variable name="users.copy.description" select="'Klicka på den grupp som användaren/användarna skall kopieras till.'" />
	...
	<xsl:variable name="groupInfoElement.users.copyusers" select="'Kopiera markerade användare'" />
	...
	<xsl:variable name="groupInfoElement.oldContent.header" select="'Gallring'" />
	<xsl:variable name="groupInfoElement.oldContent.begin" select="'Påbörja gallring'" />
	<xsl:variable name="groupInfoElement.oldContent.descriptPre" select="'Det finns just nu '" />
	<xsl:variable name="groupInfoElement.oldContent.descriptPost" select="' poster äldre än 1 år.'" />
	...
	<xsl:variable name="validationError.messageKey.UpdateFailedUserNotFound" select="'Användaren du försöker ändra hittades inte'" />
	<xsl:variable name="validationError.messageKey.NoUserChoosen" select="'Du har inte valt någon användare att flytta/kopiera'" />
