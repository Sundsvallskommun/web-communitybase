...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="RequestNewPassword.header" select="'Unohtunut salasana'" />
	<xsl:variable name="RequestNewPassword.information" select="'Anna sähköpostiosoitteesi alla olevaan lomakkeeseen ja klikkaa &quot;Pyydä uutta salasanaa&quot;. Uusi salasana lähetetään sinulle sähköpostilla.'" />
	<xsl:variable name="RequestNewPassword.email" select="'Sähköpostiosoite'" />
	<xsl:variable name="RequestNewPassword.submit" select="'Pyydä uutta salasanaa'" />
