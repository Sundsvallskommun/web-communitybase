...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="community">
		<div class="divNormal">
			...
			<xsl:if test="../admin">
				<div class="floatleft normalTableHeading" style="width: 8.5%; padding: 2px 0 0 3px;">
	...
	<xsl:template match="updateCommunity">
		<form method="POST" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			<div class="divNormal">									
				...
				<div class="noBorderDiv">
					<div class="floatleft" style="padding: 5px; text-align: right; width: 99%;">
	...
	<xsl:template match="thread">
		<div class="divNormal">	
			<div class="normalTableHeading floatleft" style="width: 90%;">			
			...
			<div class="floatleft full">
				...
				<div class="floatleft">
					<p class="addedby" style="width: 9.2em;">
	...
	<xsl:template match="addCommunityThread">
		<form method="post" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			<div class="divNormal">		
				...
				<div class="noBorderDiv">
					<div class="floatleft" style="width: 99%; padding: 5px; text-align:right">
	...
	<xsl:template match="showCommunityPosts">
		<div class="divNormal">	
			<div class="noBorderDiv floatleft" style="width: 90%;">
				<xsl:call-template name="replaceLineBreak">
			...
			<xsl:choose>
				<xsl:when test="admin">
					<div class="floatleft" style="width: 8.5%; padding: 2px 0 0 3px;">
						<div class="floatright" >
			...
			<div class="floatleft marginbottom full">
				<div class="floatleft marginbottom full">
					<p class="addedby"><xsl:value-of select="$thread.postedBy" />: 
						<xsl:choose>
			...
			<div class="floatleft">
				<form method="POST" action="{/document/requestinfo/currentURI}/{/document/module/alias}/{/document/group/groupID}/showCommunityPosts/{thread/forumThreadID}" ACCEPT-CHARSET="ISO-8859-1">
					<table class="calendar">
						...
						<tr>
							<td align="right"><textarea rows="10" name="message" cols="89" class="full" /></td>
						</tr>				
						<tr>
							<td align="right"><input class="floatright" type="submit" value="Lägg till ny post"/></td>
						</tr>
					</table>
				</form>	
			</div>
	...
	<xsl:template match="updateCommunityPost">
		<form method="POST" action="{/document/requestinfo/uri}" ACCEPT-CHARSET="ISO-8859-1">
			...
			<table class="calendar">
				...
				<tr>
					<td align="center">
						<textarea rows="16" name="message" cols="65" class="full">							
							<xsl:choose>
								<xsl:when test="requestparameters">
									<xsl:call-template name="replace-string">
										<xsl:with-param name="text" select="requestparameters/parameter[name='message']/value"/>
