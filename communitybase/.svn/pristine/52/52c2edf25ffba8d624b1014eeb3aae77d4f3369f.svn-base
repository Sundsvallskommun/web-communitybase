...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="updateForumBreadcrumb">Uppdatera forum </xsl:variable>
	<xsl:variable name="updateThreadBreadcrumb">Uppdatera tråden </xsl:variable>
	<xsl:variable name="updateForumPostBreadcrumb">Uppdatera forumpost</xsl:variable>
	...
	<xsl:variable name="updateCommunity.submit" select="'Beskrivning'" />
	...
	<xsl:variable name="updateCommunityPost.submit" select="'Ändra inlägget'" />
