...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="MoveUsers">
		...
		<form method="POST" name="moveusers" action="">
			...
			<div class="content-box">
				...
				<h1 class="header">
					<xsl:value-of select="$users.move.header" />
				</h1>
	...
	<xsl:template match="GroupInfoElement">
		...
		<div class="content-box">
			...
			<form method="POST" name="moveusers" action="{/document/requestinfo/contextpath}{/document/section/fullAlias}/{/document/module/alias}/{/document/group/groupID}/moveUsers">
				...
				<h1 class="header">
					<xsl:value-of select="$groupInfoElement.users.header" />
				</h1>
		...
		<div class="content-box">
			...
			<h1 class="header">
				<xsl:value-of select="$groupInfoElement.modules.header" />
			</h1>
	...
	<xsl:template name="createInvitationArea">
		...
		<div class="content-box">
			...
			<h1 class="header">
				<xsl:value-of select="$groupInfoElement.adduser.header" />
			</h1>
		...
		<div class="content-box">
			...
			<h1 class="header">
				<xsl:value-of select="$groupInfoElement.invitedusers.header" />
			</h1>
