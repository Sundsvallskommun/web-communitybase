...
public class Absence implements Elementable {
	...
	public Element toXML(Document doc) {
		...
		if(startTime != null && endTime != null) {
			...
			XMLUtils.appendNewElement(doc, absenceElement, "daysBetween", DateUtils.getDaysBetween(startTime, endTime) + 1);
	...
	public String toString() {
		...
		return StringUtils.toLogFormat(name, 30) + " (ID: " + absenceID + ")";
	}
