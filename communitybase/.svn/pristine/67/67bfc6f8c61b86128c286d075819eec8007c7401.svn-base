...
public class Thread {
	...
	public Element toXML(Document doc){
		...
		if(this.getChanged() != null){
			...
			changedByElement.appendChild(XMLUtils.createElement("changedDate", DateUtils.DATE_FORMATTER.format(getChanged()), doc));
			changedByElement.appendChild(XMLUtils.createElement("changedTime", TimeUtils.TIME_FORMATTER.format(getChanged()), doc));
