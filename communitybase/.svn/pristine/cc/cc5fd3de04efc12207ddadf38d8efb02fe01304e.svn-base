...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="renameSchool">
		...
		<form method="post" action="{/document/requestinfo/contextpath}{/document/section/fullAlias}/{/document/module/alias}/{/document/school/schoolID}/renameSchool">
			...
			<div class="content-box">				
				...
				<h1 class="header">
					<span><xsl:value-of select="$renameSchool.header" />: <xsl:text>&#x20;</xsl:text><xsl:value-of select="/document/school/name" /></span>
				</h1>
	...
	<xsl:template match="group" mode="update">
		...
		<form method="post" action="{/document/requestinfo/contextpath}{/document/section/fullAlias}/{/document/module/alias}/{/document/school/schoolID}/updateGroup/{groupID}">
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$group.rename.header" />: <xsl:text>&#x20;</xsl:text><xsl:value-of select="name" /></span>
				</h1>
	...
	<xsl:template match="systemInfoElement">
		...
		<div class="content-box">
			...
			<h1 class="header">
				<span><xsl:value-of select="$systemInfoElement.school.header" /></span>
			</h1>
		...
		<xsl:if test="/document/user/admin = 'true'">
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$systemInfoElement.school.addschool" /></span>
				</h1>
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$systemInfoElement.admins.header" /></span>
				</h1>
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$systemInfoElement.invitedadmins.header" /></span>
				</h1>
			...
			<div class="content-box">
				...
				<h1 class="header">
					<span><xsl:value-of select="$systemInfoElement.addadmins.header" /></span>
				</h1>
	...
	<xsl:template match="schoolInfoElement">
		...
		<div class="content-box">
			...
			<h1 class="header">
				<span><xsl:value-of select="$schoolInfoElement.groups.header" /></span>
			</h1>
		...
		<div class="content-box">	
			<h1 class="header">
				<span><xsl:value-of select="$schoolInfoElement.addgroup.header" /></span>
			</h1>
		...
		<div class="content-box">
			...
			<h1 class="header">
				<span><xsl:value-of select="$schoolInfoElement.resources.header" /></span>
			</h1>
		...
		<div class="content-box">
			...
			<h1 class="header">
				<span><xsl:value-of select="$schoolInfoElement.invitedresources.header" /></span>
			</h1>
		...
		<div class="content-box">
			...
			<h1 class="header">
				<span><xsl:value-of select="$schoolInfoElement.addresource.header" /></span>
			</h1>
