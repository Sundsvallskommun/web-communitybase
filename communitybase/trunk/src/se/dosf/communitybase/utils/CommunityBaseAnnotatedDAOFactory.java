...
public class CommunityBaseAnnotatedDAOFactory extends SimpleAnnotatedDAOFactory {
	...
	public CommunityBaseAnnotatedDAOFactory(DataSource dataSource, UserHandler userHandler) {
		
		this(dataSource, userHandler, null);
		
	}
	
	public CommunityBaseAnnotatedDAOFactory(DataSource dataSource, UserHandler userHandler, CommunitySchoolDAO schoolDAO){
		...
		typePopulators.add(new CommunityGroupTypePopulator(userHandler));
