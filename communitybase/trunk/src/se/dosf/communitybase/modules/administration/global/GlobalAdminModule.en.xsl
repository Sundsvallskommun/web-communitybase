...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="updateGroupBreadCrumbTest">Rename group: </xsl:variable>
	...
	<xsl:variable name="group.rename.header" select="'Rename the group'" />
	...
	<xsl:variable name="group.tree.changename.title" select="'Rename group'" />
