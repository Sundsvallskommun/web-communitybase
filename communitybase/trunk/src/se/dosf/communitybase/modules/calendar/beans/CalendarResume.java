...
public class CalendarResume {
	...
	private static PooledSimpleDateFormat year = new PooledSimpleDateFormat("yyyy");
	private static PooledSimpleDateFormat month = new PooledSimpleDateFormat("MM");
	private static PooledSimpleDateFormat day = new PooledSimpleDateFormat("dd");
