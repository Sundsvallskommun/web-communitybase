...
public class ForumThreadPopulator implements BeanResultSetPopulator<Thread>{
	...
	public Thread populate(ResultSet rs) throws SQLException {
		...
		thread.setPoster((CommunityUser)userHandler.getUser(rs.getInt("posterID"), false));
		...
		if(id != null){
			...
			thread.setChanger((CommunityUser)userHandler.getUser(rs.getInt("changerID"), false));
		}
